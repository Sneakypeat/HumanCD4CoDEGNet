...
SLIDES=[
 {"idx":"","label":"Claude Hackathon · Life Sciences","type":"title","eyebrow":"Researcher track",
  ...
  "script":"Hi. I'm <b>Syed Sabih ur Rehman</b>. I'm a PhD student at United Arab Emirates University. My project is called Human CD4 CoDEG Net."},
 {"idx":"","label":"The hook","type":"text",
  "headline":"The genes that switch on when an immune cell activates are druggable disease genes.",
  "script":"Here is the main finding. When a human immune cell switches on to fight an infection, a set of control genes comes online. And those genes are <b>drug targets</b>. Many of them <b>cause disease</b> when they break. Genes like ZAP70 and ITK. I found them by mapping the full control system of a human immune cell. Let me show you how."},
 {"idx":"","label":"The data","type":"text",
  "headline":"A causal map: 22M CD4⁺ T cells, every gene knocked down, at rest and after activation.",
  "script":"To do this, you need cause and effect. Not just correlation. So you switch off each gene, one at a time, and you watch what changes. The Marson lab did exactly that. They switched off every gene. In twenty two million human T cells. At rest, and after activation. For the first time, we can draw the full wiring diagram of a human immune cell."},
 {"idx":"01","label":"The architecture","type":"fig","img":f1,
  ...
  "script":"So I drew it. The network has a very clear shape. A few genes do most of the work. The top <b>five percent</b> of genes control almost <b>eighty percent</b> of everything. Most genes do almost nothing. A theory paper predicted this shape last year, from genetics alone. My work is the first to confirm it directly."},
 {"idx":"02","label":"The twist","type":"fig","img":f2,
  ...
  "script":"Now. What happens when the cell switches on? The <b>shape</b> stays the same. A few genes still control the many. That does not change. But the genes <b>in charge</b> change almost completely. Up to <b>sixty percent</b> are replaced. So the cell keeps the same shape of control. But it swaps out who is in control. The new genes in charge are the ones that read the cell's own activation signal."},
 {"idx":"03","label":"The payoff","type":"fig","img":f5,
  ...
  "script":"Here is why this matters. These new control genes are about <b>twice as likely</b> to be disease genes. And they are drug targets. ZAP70. ITK. LCK. So the control system the cell builds when it switches on is exactly where the best drug targets sit."},
 {"idx":"04","label":"Generality & close","type":"fig","img":f3,
  "headline":"Not a T-cell quirk. It survives every confound. Reproducible from public data.",
  "script":"And this is not just a T cell thing. The same shape shows up in a completely different cell type. It holds up against every test I ran. And anyone can reproduce it from public data. Thank you for watching."},
]
